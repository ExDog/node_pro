...
<html lang="en">
<head>
    <title>Code coverage report for ascoltatori/lib/mqtt_ascoltatore.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ascoltatori/lib/mqtt_ascoltatore.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">96.25% <small>(77 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ascoltatori/lib/</a> &#187; mqtt_ascoltatore.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  this._opts.mqtt = this._opts.mqtt || <span class="branch-1 cbranch-no" title="branch not covered" >require("mqtt");</span>
&nbsp;
...
&nbsp;
    ...
    this._client.on('error', <span class="fstat-no" title="function not covered" >function(e) {</span>
<span class="cstat-no" title="statement not covered" >      debug("error in the client");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      delete that._client;</span>
<span class="cstat-no" title="statement not covered" >      that.emit("error", e);</span>
    });
  }
  return this._client;
};
