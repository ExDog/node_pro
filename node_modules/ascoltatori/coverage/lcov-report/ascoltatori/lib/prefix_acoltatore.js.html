...
<html lang="en">
<head>
    <title>Code coverage report for ascoltatori/lib/prefix_acoltatore.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ascoltatori/lib/prefix_acoltatore.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ascoltatori/lib/</a> &#187; prefix_acoltatore.js</div>
</div>
<div class="body">
...
function PrefixAscoltatore(prefix, ascoltatore) {
  DecoratorAscoltatore.call(this, ascoltatore || <span class="branch-1 cbranch-no" title="branch not covered" >new TrieAscoltatore())</span>;
&nbsp;
  this._prefix = prefix;
}
&nbsp;
