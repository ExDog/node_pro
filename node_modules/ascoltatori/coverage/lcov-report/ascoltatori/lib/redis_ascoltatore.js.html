...
<html lang="en">
<head>
    <title>Code coverage report for ascoltatori/lib/redis_ascoltatore.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ascoltatori/lib/redis_ascoltatore.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.44% <small>(114 / 117)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">97.44% <small>(114 / 117)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ascoltatori/lib/</a> &#187; redis_ascoltatore.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  this._opts = opts || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
  this._opts.redis = this._opts.redis || <span class="branch-1 cbranch-no" title="branch not covered" >require("redis");</span>
&nbsp;
...
function createConn(opts, connName) {
  ...
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (opts.password !== undefined) {
<span class="cstat-no" title="statement not covered" >    debug("authenticating using password");</span>
<span class="cstat-no" title="statement not covered" >    conn.auth(opts.password);</span>
  }
...
RedisAscoltatore.prototype._startPub = function() {
  var that = this;
  <span class="missing-if-branch" title="else path not taken"" >E</span>if (this._client === undefined) {
...
RedisAscoltatore.prototype._startSub = function() {
  var that = this,
    handler = null;
&nbsp;
  <span class="missing-if-branch" title="else path not taken"" >E</span>if (this._sub === undefined) {
...
&nbsp;
  ...
  ["_sub", "_client"].forEach(function(c) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (that[c] !== undefined) {
...
<span class="cstat-no" title="statement not covered" >      closes = closes - 1;</span>
    }
  });
