...
<html lang="en">
<head>
    <title>Code coverage report for ascoltatori/lib/decorator_ascoltatore.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ascoltatori/lib/decorator_ascoltatore.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ascoltatori/lib/</a> &#187; decorator_ascoltatore.js</div>
</div>
<div class="body">
...
&nbsp;
DecoratorAscoltatore.prototype.removeListener = <span class="fstat-no" title="function not covered" >function(event, callback) {</span>
<span class="cstat-no" title="statement not covered" >  this._ascoltatore.removeListener(event, callback);</span>
};
&nbsp;
