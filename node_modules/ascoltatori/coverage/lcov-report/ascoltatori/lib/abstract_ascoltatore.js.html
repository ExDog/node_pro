...
<html lang="en">
<head>
    <title>Code coverage report for ascoltatori/lib/abstract_ascoltatore.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ascoltatori/lib/abstract_ascoltatore.js</span></h1>
    <h2>
        
        Statements: <span class="metric">87.23% <small>(41 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">89.13% <small>(41 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ascoltatori/lib/</a> &#187; abstract_ascoltatore.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1848</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1848</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1848</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1848</span>
<span class="cline-any cline-yes">1474</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1848</span>
<span class="cline-any cline-yes">1666</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2194</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >    throw new Error("This ascoltatore is closed");</span>
  }
};
&nbsp;
/**
 ...
 * @api public
 */
AbstractAscoltatore.prototype.subscribe = <span class="fstat-no" title="function not covered" >function(topic, callback, done) {</span>
<span class="cstat-no" title="statement not covered" >  throw new Error("Subclass to implement");</span>
};
&nbsp;
/**
 ...
 * @api public
 */
AbstractAscoltatore.prototype.publish = <span class="fstat-no" title="function not covered" >function(topic, payload, options, done) {</span>
<span class="cstat-no" title="statement not covered" >  throw new Error("Subclass to implement");</span>
};
&nbsp;
AbstractAscoltatore.prototype._setPublish = function() {
  var proto = Object.getPrototypeOf(this),
      ...
      newPublish;
&nbsp;
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (!f) { <span class="cstat-no" title="statement not covered" >return; </span>}
&nbsp;
  if (f.length === 4) {
 ...
 * @api public
 */
AbstractAscoltatore.prototype.unsubscribe = <span class="fstat-no" title="function not covered" >function(topic, callback, done) {</span>
<span class="cstat-no" title="statement not covered" >  throw new Error("Subclass to implement");</span>
};
&nbsp;
/**
 ...
 * @api public
 */
AbstractAscoltatore.prototype.close = <span class="fstat-no" title="function not covered" >function(done) {</span>
<span class="cstat-no" title="statement not covered" >  throw new Error("Subclass to implement");</span>
};
&nbsp;
/**
