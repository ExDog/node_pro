...
<html lang="en">
<head>
    <title>Code coverage report for ascoltatori/lib/subs_counter.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ascoltatori/lib/subs_counter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ascoltatori/lib/</a> &#187; subs_counter.js</div>
</div>
<div class="body">
...
SubsCounter.prototype.forEach = function(callback) {
  ...
  for (key in this._obj) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (this._obj.hasOwnProperty(key)) {
      callback(key);
    }
  }
&nbsp;
